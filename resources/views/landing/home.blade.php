  ...
  <div class="hero_area">
    <div class="bg-box">
      ...
      <video width="100%" height="auto" autoplay loop muted>
        <source src="images/raising_canes.mp4" type="video/mp4">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="container">
              ...
              <div class="detail-box" style="display: flex; justify-content: center; align-items: center; height: 100vh; width: 100%;">
              ...
              <div class="content" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                  ...
                  <div class="btn-box">
                      <a href="https://www.ubereats.com/..." target="_blank" rel="noopener noreferrer" class="btn1">Order Now</a>
                  </div>
              </div>
          </div>
